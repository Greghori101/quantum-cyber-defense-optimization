...
The rest of the paper is organized as follows. Related Work reviews existing literature. Cyber-Defense State-Space Model presents the proposed model. Finite-Horizon LQR-to-QUBO Formulation derives the optimization framework. Optimization Methods describes the solution approaches. Experimental Design outlines the evaluation methodology. Results presents the experimental findings. Discussion analyzes the results and limitations. Finally, Conclusion summarizes the paper and future directions.
